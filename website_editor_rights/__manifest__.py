...
{
    'name': 'User Mail: Website Editor Rights',
    'version': '14.0.1.1.0',
    ...
    'category': 'Technical',
    'description': """
    This module gives memebers of group website_pubslisher rights that belongs to a normal website Editor.
    """,
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-user-mail/website_editor_rights',
