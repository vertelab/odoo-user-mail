...
{
    'name': 'User Mail: Website Publisher Info',
    'version': '14.0.1.0.0',
    ...
    'category': 'Technical',
    'description': """
    Information about the website for a website publisher.
    """,
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-user-mail/website_publisher_info',
